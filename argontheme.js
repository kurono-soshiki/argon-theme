...
translation['ja'] = {
	...
	"清除": "Clear",
	"恢复博客默认": "Set To Default",
	"评论内容不能为空": "コメントの内容は空にできません",
	"昵称不能为空": "名前は空にできません",
	"邮箱或 QQ 号格式错误": "正しくないメールアドレスまたはQQの形式です",
	"邮箱格式错误": "正しくないメールアドレスの形式です",
	"网站格式错误 (不是 http(s):// 开头)": "ウェブサイトのURLの形式が正しくありません（http(s)://で始まる必要があります）",
	"验证码未输入": "CAPTCHAは空にできません",
	"验证码格式错误": "正しくないCAPTCHAの形式です",
	"评论格式错误": "コメントの形式が正しくありません",
	"发送中": "送信中",
	"正在发送": "送信中",
	"评论正在发送中...": "コメントが送信中です...",
	"发送": "送信",
	...
	"评论正在编辑中...": "コメントが編集中です...",
	"编辑": "編集",
	"评论编辑失败": "コメントの編集に失敗しました",
	"已编辑": "編集済み",
	"编辑成功": "成功",
	"您的评论已编辑": "コメントが編集されました",
	"评论 #": "コメント #",
	"的编辑记录": "- 編集履歴",
	"加载失败": "読み込みに失敗しました",
	"展开": "表示",
	"没有更多了": "コメントはこれ以上ありません",
	"找不到该 Repo": "リポジトリが見つかりません",
	"获取 Repo 信息失败": "リポジトリ情報の取得に失敗しました",
	"点赞失败": "投票に失敗しました",
	"Hitokoto 获取失败": "Hitokotoの取得に失敗しました",
	"复制成功": "コピーしました",
	"代码已复制到剪贴板": "コードがクリップボードにコピーされました",
	"复制失败": "失敗しました",
	"请手动复制代码": "コードを手動でコピーしてください",
	"刚刚": "たった今",
	"分钟前": "分前",
	"小时前": "時間前",
	"昨天": "昨日",
	...
	"置顶评论": "コメントを固定",
	"取消置顶评论": "コメントの固定を解除",
	"是否要取消置顶评论 #": "コメント # の固定を解除しますか",
	"是否要置顶评论 #": "コメント # を固定しますか",
	"确认": "確認",
	"取消": "キャンセル",
	"置顶": "固定",
	"取消置顶": "固定解除",
	"置顶成功": "固定済み",
	"取消置顶成功": "固定解除済み",
	"该评论已置顶": "コメントは固定されています",
	"该评论已取消置顶": "コメントの固定は解除されました",
	"置顶失败": "固定に失敗しました",
	"取消置顶失败": "固定解除に失敗しました",
};
function __(text){
